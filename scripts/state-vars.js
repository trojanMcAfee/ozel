...
const proxyABIeth = [
    ...
    'function sendToArb((address,address,uint256,string),uint256,uint256,address,bytes) external payable',
    'function initialize((address,address,uint256,string),address,bytes)',
